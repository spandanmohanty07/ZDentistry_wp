                ...
                <div class="bg-slate-50">
                    <div class="mo-pricing-snippet-grid">
                        ...
                        <div class="mo-pricing-card" >
                            <div>
                                <h4>
                                    Miniorange Gateway<br>with addons
                                </h4>
                            </div>    

                            <div class="flex items-center px-mo-4 py-mo-3 bg-green-100 rounded-md gap-mo-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                  <g id="c8a4e4329ccb76f695ceb40848bc01eb">
                                    <g id="64c022ae94903d52028b6a80786ed8af">
                                      ...
                                      <path d="M13.9796 5.36772C14.1533 4.87743 14.8467 4.87743 15.0204 5.36772L15.6158 7.04814C15.6715 7.20508 15.7949 7.32855 15.9519 7.38415L17.6323 7.97958C18.1226 8.15331 18.1226 8.84669 17.6323 9.02042L15.9519 9.61585C15.7949 9.67146 15.6715 9.79492 15.6158 9.95186L15.0204 11.6323C14.8467 12.1226 14.1533 12.1226 13.9796 11.6323L13.3842 9.95186C13.3285 9.79492 13.2051 9.67146 13.0481 9.61585L11.3677 9.02042C10.8774 8.84669 10.8774 8.15331 11.3677 7.97958L13.0481 7.38415C13.2051 7.32855 13.3285 7.20508 13.3842 7.04814L13.9796 5.36772Z" fill="#363853"></path>
                                    </g>
                                  </g>
                                </svg>
                                <p class="m-mo-0 font-bold text-gray-900">10 Free SMS & Emails</p>
                            </div>

                            <ul class="grow mt-mo-2" id="mo-gateway-plan-features">
                                ...
                                <li class="feature-snippet">
                                    <span class="mt-mo-1">'.$circleIcon.'</span>
                                    <p class="m-mo-0 font-bold">Miniorange Gateway Support</p>
                                </li> 

                            </ul>
                            <div class="flex grow mt-mo-4" id="sms-email-pricing-table" style="display: none">
                                <div class="mo-sms-email-pricing">
                                    <table id="email-pricing">
                                        <tr>
                                            <td>
                                                <b>Emails</b>
                                            </td>
                                ...
                                <p class="my-mo-4 !text-[10px]">
                                    SMS Pricing vary depending on country you\'re targeting.
                                </p>
                                <span class="grow"></span>
                                <button class="min-w-full mo-button primary mt-mo-4 mb-mo-2" onclick="mo2f_upgradeform(\'wp_otp_verification_basic_plan\')">Upgrade Now</button>                                
                            </div>
                            <button id="sms-email-pricing-check" class="w-full mo-button primary">See Pricing</button>
                        </div>

                        <div class="mo-pricing-card" >
                            <div>
                                <h5>Custom Gateway<br>with addons</h5>
                                <div class="my-mo-4 flex">
                                    <h2 class="m-mo-0">$29</h2>
                                </div>
                            </div> 

                            <ul class="mt-mo-2 grow" id="mo-gateway-plan-features">
                                <li class="feature-snippet">
                                    <span class="mt-mo-1">'.$circleIcon.'</span>
                                    <p class="m-mo-0">Passwordless Login</p>
                                </li>
...
echo '
    <script>
        ...
        const moGatewayFeaturesDiv = document.getElementById("mo-gateway-plan-features");
        const moGatewayPricingDiv = document.getElementById("sms-email-pricing-table");
        const showPricingButton = document.getElementById("sms-email-pricing-check");
        const moSectionHeading = document.getElementById("mo-section-heading");
       


        showPricingButton.addEventListener("click",function(event){
            const btnText = event.target.textContent;
            if(btnText === "Back to Features"){
                moGatewayPricingDiv.style.display = "none";
                moGatewayFeaturesDiv.style.display = "block";
                showPricingButton.textContent = "See Pricing";
                toggleClasses(showPricingButton,["primary"],["secondary"])
            }else{
                moGatewayPricingDiv.style.display = "block";
                moGatewayFeaturesDiv.style.display = "none";
                showPricingButton.textContent = "Back to Features";
                toggleClasses(showPricingButton,["secondary"],["primary"])
            }
        });
